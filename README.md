...
A static Vercel-ready research dashboard for public GTA distressed property signals, inspired by clean real-estate search products while avoiding private MLS scraping.
...
The site uses public source links and estimated underwriting. It does not bypass HouseSigma, REALTOR.ca, MLS, brokerage, or paid-login restrictions. Sold comparables, legal-suite status, zoning, licensing, and property condition must be verified before any investment decision.
